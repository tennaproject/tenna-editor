...
export const ENEMIES = {
  ...
  NUBERT: 122,
  EXAMPLE: 123,
  MULTIBOSS_EXAMPLE: 500,
  MULTIBOSS_C_EXAMPLE: 501,
};
...
export const ENEMIES_META: Record<EnemyIndex, EnemyProperties> = {
  ...
  [ENEMIES.FLORADINN]: {
    ...
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_FLORADINN,
    recruitCount: 2,
  },
  [ENEMIES.LEAFLING]: {
    displayName: 'Leafling',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_LEAFLING,
    recruitCount: 2,
  },
  [ENEMIES.SHI]: {
    displayName: 'Shi',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_SHI,
    recruitCount: 4,
  },
  [ENEMIES.SHINOBEETLE]: {
    displayName: 'Shinobeetle',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_SHINOBEETLE,
    recruitCount: 3,
  },
  [ENEMIES.KAWKAW]: {
    displayName: 'KawKaw',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_KAWKAW,
    recruitCount: 2,
  },
  [ENEMIES.SHEARY]: {
    displayName: 'Sheary',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_SHEARY,
    recruitCount: 2,
  },
  [ENEMIES.NETSKIE]: {
    displayName: 'Netskie',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_NETSKIE,
    recruitCount: 2,
  },
  [ENEMIES.TERAKOTA]: {
    displayName: 'Terakota',
    recruitable: true,
    recruitFlag: FLAGS.RECRUITED_TERAKOTA,
    recruitCount: 2,
  },
  [ENEMIES.ENEMY_78]: { displayName: '???', recruitable: false },
  [ENEMIES.ENEMY_79]: { displayName: '???', recruitable: false },
  [ENEMIES.ENEMY_80]: { displayName: '???', recruitable: false },
  [ENEMIES.ENEMY_112]: { displayName: '???', recruitable: false },
  [ENEMIES.ORANGE]: { displayName: 'Orange', recruitable: false },
  [ENEMIES.GREEN]: { displayName: 'Green', recruitable: false },
  [ENEMIES.BLUE]: { displayName: 'Blue', recruitable: false },
  [ENEMIES.YELLOW]: { displayName: 'Yellow', recruitable: false },
  [ENEMIES.SETH]: { displayName: 'Seth', recruitable: false },
  [ENEMIES.PINK]: { displayName: 'Pink', recruitable: false },
  [ENEMIES.FLOWERY]: { displayName: 'Flowery', recruitable: false },
  [ENEMIES.BALL]: { displayName: 'Ball', recruitable: false },
  [ENEMIES.TRASHY_TRIO]: { displayName: 'Trashy Trio', recruitable: false },
  [ENEMIES.NUBERT]: { displayName: 'Nubert', recruitable: false },
  [ENEMIES.EXAMPLE]: { displayName: 'Example', recruitable: false },
  [ENEMIES.MULTIBOSS_EXAMPLE]: {
    displayName: 'Multiboss Example',
    recruitable: false,
  },
  [ENEMIES.MULTIBOSS_C_EXAMPLE]: {
    displayName: 'Multiboss C Example',
    recruitable: false,
  },
};
